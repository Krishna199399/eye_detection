...
const Button = React.forwardRef(({
    ...
    return (
        <Comp
            ...
            {...props}
            onClick={(e) => {
                console.log('Button: onClick fired', { disabled, loading, type: props.type });
                if (props.onClick) {
                    console.log('Button: calling original onClick');
                    return props.onClick(e);
                }
                console.log('Button: no onClick prop provided');
            }}
        >
            {loading && <LoadingSpinner />}
            {iconName && iconPosition === 'left' && renderIcon()}
